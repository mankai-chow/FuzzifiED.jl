...
cpd_int_l1_0 = PrepareCouple(CoupleDecomps([ n_mod, n_mod ], RecouplePsPot(s, s, s, s, [Int64[4s 4s;4s 2]], [1.0])..., [ 0 0 ; 0 0 ]))
...
cpd_int_l1_1 = PrepareCouple(CoupleDecomps([ n_mod, n_mod ], RecouplePsPot(s, s, s, s, [Int64[4s-2 4s-2;4s-2 2]], [1.0])..., [ 0 0 ; 0 0 ]))
