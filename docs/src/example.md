...
* [`sp3_spectrum.jl`](https://github.com/mankai-chow/FuzzifiED.jl/blob/main/examples/sp3_spectrum.jl) calculates the spectrum of Sp(3) CFT on fuzzy sphere. This example reproduces Table I in [arXiv : 2409.*****](https://arxiv.org/abs/2409.00000).