...
* [`so5_spectrum.jl`](https://github.com/mankai-chow/FuzzifiED.jl/blob/main/examples/o3_spectrum.jl) calculates the spectrum of SO(5) DQCP on fuzzy sphere. This example reproduces Table II in [Phys. Rev. X 14, 021044 (2024)](https://doi.org/10.1103/PhysRevX.14.021044).