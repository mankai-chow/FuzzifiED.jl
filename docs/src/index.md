...
The function used to implement the conserved quantities and generate all the configurations (_i.e._, direct product states) is [`Confs`](@ref). There are two conserved quantities in the Ising model, _viz._ the particle number and the angular momentum
...
```@docs
Operator
Operator(bsd :: Basis, bsf :: Basis, cstr_vec :: Vector{Any}, fac :: Vector{ComplexF64} ; red_q :: Int64 = 0, sym_q :: Int64 = 0)
OperatorFromOpSum(bsd :: Basis, bsf :: Basis, opsum :: Sum{Scaled{ComplexF64, Prod{Op}}} ; red_q :: Int64 = 0, sym_q :: Int64 = 0)
```

### Generating and diagonalising sparse matrix
