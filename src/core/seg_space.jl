...
* `sec :: Matrix{Int64}` collects the QNDiag sectors that are diagonalised. It takes two indices `sec[iqn, isec]` where `iqn` is the index of the QNDiag and `isec` is the index of the sector.
