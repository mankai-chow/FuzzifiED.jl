...
"""
function OpMat(op :: Operator ; type :: DataType = ComplexF64, num_th = NumThreads, silent_std = SilentStd)
...
"""
function GetEigensystem(mat :: OpMat{ComplexF64}, nst :: Int64 ; tol :: Float64 = 1E-8, ncv :: Int64 = max(2 * nst, nst + 10), num_th = NumThreads, silent_std = SilentStd)
...
function GetEigensystem(mat :: OpMat{Float64}, nst :: Int64 ; tol :: Float64 = 1E-8, ncv :: Int64 = max(2 * nst, nst + 10), num_th = NumThreads, silent_std = SilentStd)
...
"""
function *(mat :: OpMat{ComplexF64}, st_d :: Vector{ComplexF64} ; num_th = NumThreads, silent_std = SilentStd)
...
function *(mat :: OpMat{Float64}, st_d :: Vector{Float64} ; num_th = NumThreads, silent_std = SilentStd)
...
"""
function *(st_fp :: LinearAlgebra.Adjoint{ComplexF64, Vector{ComplexF64}}, mat :: OpMat{ComplexF64}, st_d :: Vector{ComplexF64} ; num_th = NumThreads, silent_std = SilentStd)
...
function *(st_fp :: LinearAlgebra.Adjoint{Float64, Vector{Float64}}, mat :: OpMat{Float64}, st_d :: Vector{Float64} ; num_th = NumThreads, silent_std = SilentStd)
